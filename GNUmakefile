...
install_AIO2.tgz : dependencies.txt README.md install_AIO2.ex euphoria-$(EU40REV).tar makearchive.ex install_AIO2 GNUmakefile euslibs.tar mylibs.tar euphoria-$(EU41REV).tar revisions.GNUmake revisions.e
	tar -czf install_AIO2.tgz install_AIO2 dependencies.txt README.md install_AIO2.ex euphoria-$(EU40REV).tar makearchive.ex GNUmakefile euslibs.tar mylibs.tar euphoria-$(EU41REV).tar revisions.GNUmake revisions.e
